...
{
    public class DisplayDishToDrinksModel
    {
        ...
        private Panel panel;
        public DisplayDishToDrinksModel(FlowLayoutPanel layoutPanel, DishesModels dishes, DishDbContext dbContext, string connString, Panel panel)
        {
