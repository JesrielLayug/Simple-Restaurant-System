...
{
    public class DisplayDishToBakeryModel
    {
        ...
        private Panel panel;
        public DisplayDishToBakeryModel(FlowLayoutPanel layoutPanel, DishesModels dishes, DishDbContext dbContext, string connString, Panel panel)
        {
